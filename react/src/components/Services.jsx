  ...
  return (
    <section ref={containerRef} className="relative bg-bg-dark py-section-padding overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <motion.div
          className="absolute -right-1/4 -top-1/4 w-1/2 h-1/2 bg-gradient-conic from-[#FF7F50]/10 to-transparent rounded-full blur-3xl"
          animate={{
            scale: [1, 1.2, 1],
            opacity: [0.2, 0.3, 0.2],
          }}
      ...
      <div className="relative container mx-auto px-4">
        ...
        <div className="relative">
          {/* 接続線 */}
          <div className="absolute left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-[#FF7F50]/0 via-[#FF7F50]/30 to-[#FF7F50]/0" />
          ...
          {services.map((service, index) => (
            ...
            >
              {/* タイムラインドット */}
              <motion.div
                className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-4 h-4 rounded-full bg-[#FF7F50]"
                initial={{ scale: 0 }}
                whileInView={{ scale: 1 }}
                viewport={{ once: true }}
                ...
                >
                  ...
                  <ul className="space-y-3">
                    {service.features.map((feature, featureIndex) => (
                      ...
                      >
                        <span className="w-1.5 h-1.5 rounded-full bg-[#FF7F50] mr-3" />
                        {feature}
                      </motion.li>
                    ))}
                  </ul>
